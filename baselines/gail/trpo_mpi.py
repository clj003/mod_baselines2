...
def traj_segment_generator(pi, env, reward_giver, horizon, stochastic):
    ...
    while True:
        ...
        # I'm guessing the returns for these are being pulled from collected data returns? verify: 

        # print("trpo_mpi true_reward values from environment: ", true_rew) # print out the true reward to see if this exists, exists but is zero
        # print("trpo_mpi, printing out true_rews array: ", true_rews) # exists and is just zeros as expeccted
